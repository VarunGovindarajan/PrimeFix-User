...
// Replace with your real image imports or URLs
import generalService from '../../assets/AC_REPAIRING.jpg';
import acRepair from '../../assets/ac repairing.jpg';

const acServices = [
  { id: 1, name: "General AC Service", price: 500, time: "45 mins", image: generalService },
  { id: 2, name: "AC Repair", price: 1200, time: "60 mins", image: acRepair },
  { id: 3, name: "AC Gas Refill", price: 2500, time: "90 mins", image: "/icons/gas-refill.png" },
  { id: 4, name: "AC Installation", price: 1500, time: "75 mins", image: "/icons/install.png" },
  { id: 5, name: "AC Uninstallation", price: 800, time: "60 mins", image: "/icons/uninstall.png" },
];
...
const ACService = () => {
  ...
  const selectedItems = acServices.filter(s => selected.includes(s.id));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 p-6">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">AC Services</h1>
        <p className="text-gray-500 mt-1 text-sm">Cooling solutions by certified technicians</p>
      </div>
