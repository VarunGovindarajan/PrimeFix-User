...
const services = [
  { id: 1, name: 'Fan Installation', price: 300, time: '30 mins', image: '/icons/fan.png' },
  { id: 2, name: 'Light Fitting', price: 250, time: '25 mins', image: '/icons/light.png' },
  { id: 3, name: 'Switch Repair', price: 150, time: '20 mins', image: '/icons/switch.png' },
  { id: 4, name: 'Wiring Fix', price: 500, time: '1 hour', image: '/icons/wiring.png' },
  { id: 5, name: 'Inverter Setup', price: 800, time: '1.5 hours', image: '/icons/inverter.png' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-yellow-50 p-6">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Electrical Services</h1>
        <p className="text-gray-500 mt-1 text-sm">Reliable electricians at your doorstep</p>
      </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            ...
            >
              ...
              <p className="text-yellow-600 font-bold mt-1">₹{service.price}</p>
              <button
