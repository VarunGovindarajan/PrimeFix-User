...
const services = [
  { id: 1, name: 'CCTV Camera Installation', price: 1500, time: '2 hours', image: '/icons/cctv.png' },
  { id: 2, name: 'Smart Door Lock Setup', price: 2000, time: '1.5 hours', image: '/icons/smart-lock.png' },
  { id: 3, name: 'Video Doorbell Setup', price: 1200, time: '1 hour', image: '/icons/video-doorbell.png' },
  { id: 4, name: 'Home Alarm System Install', price: 2500, time: '2.5 hours', image: '/icons/alarm-system.png' },
  { id: 5, name: 'Motion Sensor Configuration', price: 1000, time: '1 hour', image: '/icons/motion-sensor.png' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 p-6">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Home Security & Automation</h1>
        <p className="text-gray-500 mt-1 text-sm">Secure and automate your home with smart devices</p>
      </div>
