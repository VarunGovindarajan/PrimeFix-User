...
const services = [
  { id: 1, name: 'TV Installation / Repair', price: 600, time: '45 mins', image: '/icons/tv.png' },
  { id: 2, name: 'Refrigerator Repair', price: 700, time: '1 hour', image: '/icons/fridge.png' },
  { id: 3, name: 'Washing Machine Repair', price: 650, time: '1 hour', image: '/icons/washing-machine.png' },
  { id: 4, name: 'Microwave Repair', price: 500, time: '45 mins', image: '/icons/microwave.png' },
  { id: 5, name: 'Mobile Repair', price: 300, time: '30 mins', image: '/icons/mobile.png' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 p-6">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Mobile & Electronics Services</h1>
        <p className="text-gray-500 mt-1 text-sm">Expert care for your devices & appliances</p>
      </div>
