...
const services = [
  { id: 1, name: 'Furniture Assembly', price: 700, time: '1 hour', image: '/icons/furniture.png' },
  { id: 2, name: 'Door Lock Repair', price: 500, time: '45 mins', image: '/icons/lock-repair.png' },
  { id: 3, name: 'Window Repair', price: 600, time: '1 hour', image: '/icons/window-repair.png' },
  { id: 4, name: 'Drawer/Fitting Fix', price: 400, time: '30 mins', image: '/icons/drawer.png' },
  { id: 5, name: 'Custom Shelving Installation', price: 900, time: '1.5 hours', image: '/icons/shelf.png' },
];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 p-6">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Carpentry Services</h1>
        <p className="text-gray-500 mt-1 text-sm">Fix, build, and customize your wooden essentials</p>
      </div>
