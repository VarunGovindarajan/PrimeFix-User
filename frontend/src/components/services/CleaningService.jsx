...
import bathroomImg from '../../assets/HOUSE KEEPING.jpg';
import kitchenImg from '../../assets/HOUSE KEEPING.jpg';

const cleaningServices = [
  { id: 1, name: "Bathroom Deep Cleaning", price: 600, time: "45 mins", image: bathroomImg },
  { id: 2, name: "Kitchen Deep Cleaning", price: 800, time: "60 mins", image: kitchenImg },
  { id: 3, name: "Toilet Cleaning", price: 300, time: "20 mins", image: "/icons/toilet.png" },
  { id: 4, name: "Sink and Tap Cleaning", price: 200, time: "15 mins", image: "/icons/sink-cleaning.png" }
];
...
const CleaningService = () => {
  ...
  const selectedItems = cleaningServices.filter(s => selected.includes(s.id));
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 p-6">
      ...
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-extrabold text-gray-800">Bathroom & Kitchen Cleaning</h1>
        <p className="text-gray-500 mt-1 text-sm">Professional cleaning for a hygienic home</p>
      </div>
